...
my $resjson = $ua->get("https://maps.googleapis.com/maps/api/place/details/json?location=$lat,$lng&fields=name,geometry&radius=5000&key=AIzaSyC8BavSYT3W-CNuEtMS5414s3zmtpJLPx8&keyword=$keywd")->res->json;
